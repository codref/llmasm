...
def render_planner_prompt(
    *,
    ...
    required = [
        ...
        "- For follow-up or metacognitive questions about prior answers or the conversation "
        "itself (e.g. 'why did you say that', 'explain your reasoning', 'what was the previous answer'), "
        "do NOT use tools. Use intent -> model -> final — the model receives the prior conversation "
        "as context and can answer from it.\n"
